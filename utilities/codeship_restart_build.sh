...
# attempts to mimic behavior of original v1 API restart CodeShip build script
...
class CodeshipRestartBuild
  ...
  def initialize
    ...
    @machine_user_email = ENV['CODESHIP_MACHINE_USER_EMAIL'] || abort("Please generate a new CodeShip user with limited permissions and provide password as environment variable: CODESHIP_MACHINE_USER_EMAIL=YOUR_MACHINE_USER_EMAIL")
